# ===============================================================================
# TestAirTransportationDMV01.py: Simplified model of air transportation in the
# DMV region. 
# 
# Three main steps: 
# 
...
def main():
    print("--- Enter TestAirTransportationDMV01.main()           ... ");
    print("--- ================================================= ... ");
    print("");
    ...
    print("--- ================================================= ... ");
    print("--- Leave TestAirTransportationDMV01.main()           ... ");
